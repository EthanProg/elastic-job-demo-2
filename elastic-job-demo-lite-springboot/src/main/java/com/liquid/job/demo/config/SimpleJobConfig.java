...
package com.liquid.job.demo.config;
...
import com.liquid.job.demo.job.DemoSimpleJob;
import com.liquid.job.demo.sharding.SingleColumnShardingStragy;
...
public class SimpleJobConfig {
	...
	private LiteJobConfiguration getLiteJobConfiguration(final Class<? extends SimpleJob> jobClass, final String cron,
		...
		return LiteJobConfiguration
				...
				.jobShardingStrategyClass(SingleColumnShardingStragy.class.getCanonicalName()).overwrite(true).build();
	}
}
